        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Core data science and analytics tools for machine learning
                workflows and exploratory modeling.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Computer vision and deployment frameworks for scalable AI
                systems and real-time pipelines.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Image Augmentation</div>
              </div>
              <h5>Backend & Cloud</h5>
              <div className="what-content-flex">
